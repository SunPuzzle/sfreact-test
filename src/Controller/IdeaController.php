...
{
    #[Route('/', name: 'app_idea_index', defaults: ['page' => 1], methods: ['GET'])]
    public function index(int $page, IdeaRepository $ideaRepository, SerializerInterface $serializer): Response
    {
        $ideas = $ideaRepository->findAll($page);

        return $this->render('idea/index.html.twig', [
            //'data' => $serializer->normalize($ideas),
            'ideas' => $ideas,
        ]);
    }
